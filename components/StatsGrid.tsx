    ...
    <div className="container mx-auto px-4 -mt-10 relative z-20 mb-32 max-w-6xl">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div 
                ...
                className="bg-white border border-slate-200 p-8 rounded-2xl shadow-xl flex flex-col items-center text-center hover:border-emerald-500/50 hover:bg-emerald-500/5 cursor-pointer transition-all duration-300 group relative overflow-hidden"
            >
            ...
            <div 
                ...
                className="bg-white border border-slate-200 p-8 rounded-2xl shadow-xl flex flex-col items-center text-center hover:border-amber-500/50 hover:bg-amber-500/5 cursor-pointer transition-all duration-300 group relative overflow-hidden"
            >
            ...
            <div 
                ...
                className="bg-white border border-slate-200 p-8 rounded-2xl shadow-xl flex flex-col items-center text-center hover:border-rose-500/50 hover:bg-rose-500/5 cursor-pointer transition-all duration-300 group relative overflow-hidden"
            >
