    ...
    <div className="relative w-full py-32 lg:py-48 flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="relative z-20 container mx-auto px-4 flex flex-col items-center text-center">
        ...
        <h1 className="flex flex-wrap justify-center items-baseline font-playfair leading-none mb-8 relative drop-shadow-sm">
            <span className="text-7xl sm:text-8xl md:text-9xl lg:text-[10rem] text-transparent bg-clip-text bg-gradient-to-r from-emerald-500 to-emerald-600 font-semibold tracking-tight pb-4 inline-block">
                Yogic
            </span>
            <span className="text-7xl sm:text-8xl md:text-9xl lg:text-[10rem] text-emerald-950 font-bold tracking-tighter pb-4 inline-block">
                Animals
            </span>
        </h1>
